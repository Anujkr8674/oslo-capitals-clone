  ...
  return (
    <div className="account-types">
      ...
      <header className="account-section">
        <h1>VIP Special Account</h1>
        {/* <button>Open an Acc</button> */}
        <p>Become A VIP Trader, With Wealth Way, And Trade On Raw Spreads With Lowest Commission</p>
    ...
    <div className="accounttext">
        <p><b>The Oslo Capitals trader account is designed for VIP traders elementary in Forex market who are interested to trade on raw speed with the lower commission. The VIP account accommodates the VIP retail traders or the institutional traders, a key feature is flexibility in the position sizing, for a single trade the limit size is 20 lots, a minimum trade size is of 0.01 Raw ECN speed starting from 0 pip.</b></p>
    </div>
      ...
      <section className="account-comparison1">
        <br/><br/>
        <h2>VIP Special Trading Account</h2><br/>
        {/* <div className="account-plans1"> */}
   
          <div className="account-vip">
          <h5>Most popular</h5>
            <h3>VIP  Specia Account</h3>
            <p id="vipp">Offers competitive spreads, advanced tools, increased leverage, and <br/>enhanced safety features, empowering you to trade with precision, control,</p>
            <p id="p">$50,000</p>
            ...
            <p>From 2 pipes</p><br/>
            <h4>Safety Net</h4>
            <p>You have negative balance protection, <br/>safeguarding your account</p><br/>
            ...
            <p>Benefit from competitive swap rates, or opt for<br/> a <b>Sharia-compliant Islamic account if you prefer.</b></p><br/>
            <h4>
            Scalping Restrictions</h4>
            <p><b>Scalping is not allowed</b>, ensuring a stable <br/>and fair trading environment</p><br/>
            <h4>Comprehensive Training</h4>
            <p>Enhance your trading skills with our <b>professional<br/> training resources,</b> designed to help you succeed.</p><br/>
            <h4>Profit Potential</h4>
            <p>Capitalize on market opportunities with the <br/><b>potential to earn profits of up to 10%</b></p><br/>
           
          {/* </div> */}
          </div>
        

        <div id="imp" className="imp1">
          ...
          <ul>
            ...
            <li>* Leverage may be different depending on the asset group. Leverage is subjected to change without prior notice for any accounts type and/or due to markets conditions, news event and/or account balance.</li>
            <li>** To view the leverage for each product please visit our Markets pages.</li>
            <li>*** Minimum trading lots requirement must be done</li>
            <li>****Leverage could be decreased without prior notice for any instrument or account depending on current market conditions and account balance.</li>
            <li>*****One hour before the market closure, without prior notice margin call and/or stop out levels can be increased to 200%. It is sole responsibility of clients to have enough balance on the account for the trading</li>
            <li>positions that are planned to be left over the weekend.</li>
            <li>******VPS – With 15 trading round trip lots per month Virtual private server is provided for free.</li>
