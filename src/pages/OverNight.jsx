  ...
  return (
    <div className="overnight-container">
      ...
      <section className="overnight-text" >
       ...
       <p>Rollover is agreed on through a swap contract, which comes at a cost or gain for traders. Oslo Capitals does not close and re-open positions, but it simply debits or credits trading accounts for positions held open overnight, depending on the current interest rates.</p>
      </section>

      <section id="overnight-rollover" className="overnight-text" >
        <h2 >Oslo Capitals Rollover Policy</h2>
       <p>Oslo Capitals debits or credits clients’ accounts and handles rollover interest at competitive rates for all positions held open after 22:00 GMT, the daily bank cutoff time.</p>
       <p>Although there is no rollover on Saturdays and Sundays when the markets are closed, banks still calculate interest on any position held open over the weekend. To level this time gap, Oslo Capitals applies a 3-day rollover charge on Wednesdays for Forex and Spot Metals (Gold and Silver), and on Fridays for CFDs on Cash Indices, Cash Energies, and Stocks.</p>
      </section>

      <section  className="overnight-text">
        <h2 >Calculating Rollover</h2>
        <h2>For Forex and Spot Metals (Gold and Silver)</h2>
        <p>Rollover rates for positions on forex instruments and spot metals are charged the tomorrow-next day (i.e. tomorrow, and the next day) rate, including the Oslo Capitals mark-up for holding positions overnight. Tom-next rates are not determined by Oslo Capitals but are derived from the interest rate differential between the two currencies that a position was taken in.</p>
        ...
        <p>Assuming that you trade in USDJPY and that the tom-next rates are as follows:<br/>
            ...
            In this scenario, the interest rates in the USA are higher than in Japan. A long position in the currency pair held open overnight would receive +0.5% – the Oslo Capitals mark-up.<br/>
            Conversely, for a short position the calculation is -1.5% – the Oslo Capitals mark-up.
        </p>
        <p>More generally, the calculation is as follows:</p>
        <p><strong>Trade size X (+/- tom-next rate – the Oslo Capitals mark-up)*</strong></p>
      ...
      <section className="overnight-text" >
        ...
        <p>Rollover rates for positions on stock and stock indices are determined by the underlying interbank rate of the stock or index (for example, for an Australian-listed security, that would be the interest rate charged between Australian banks for short-term loans), plus/minus the Oslo Capitals mark-up on long and short positions respectively.</p>
        <strong>example:</strong>
        <p>Assuming that you trade in Unilever (a UK-listed stock) and that the short-term interbank rate in the UK is 1.5% p.a., for a long position held open overnight, the calculation is as follows:<br/>
            -1.5%/365 – the Oslo Capitals daily mark-up<br/>
            Conversely, the calculation for a short position is +1.5%/365 – the Oslo Capitals daily mark-up.
        </p><br/>
        <strong>More generally, the calculation is as follows (with daily rates as seen below):<br/>
            Trade size X closing price X (+/- short-term interbank rate – the Oslo Capitals mark-up) <br/>
